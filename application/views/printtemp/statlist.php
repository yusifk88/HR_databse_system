        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <table class="table table-condensed table-striped table-hover">
                ...
                <tr>
                    ...
                    <th id="col7" style="text-align: center;" >RANK/GRADE</th>
                    <th id="col23"  style="text-align: center;">STATUS/LEAVE DATE</th>
                ...
                if(count($stafflist)>0){
                    ...
                    foreach($stafflist as $staff){
                        ...
                        <tr>
                            ...
                            <td id="col23" style="text-align: center;" ><?=$staff->dentry?></td>
